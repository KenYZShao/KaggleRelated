#version 330 //Original Code, otherwise is edited by Shao guided by Avi's shader

in vec4 vCol;
in vec2 TexCoord;
in vec3 Normal;
in vec3 FragPos;//Original Code
...
uniform vec3 lightPos;//Original Code
uniform float farPlane;//Original Code
...
void main()//Original Code
{//Original Code
	float distance = length(FragPos.xyz - lightPos);//Original Code
	distance = distance/farPlane;//Original Code
	gl_FragDepth = distance;//Original Code
